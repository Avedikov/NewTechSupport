    ...
    public partial class Init : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "Users",
                columns: new[] { "Id", "CreatedAt", "Department", "Email", "IsActive", "LastLogin", "Name", "PasswordHash", "Position", "Role", "Salt", "Username" },
                values: new object[,]
                {
                    { 1, new DateTime(2025, 5, 27, 15, 25, 17, 736, DateTimeKind.Utc).AddTicks(6201), "IT", "admin@example.com", true, null, "Администратор", "12345", "Главный администратор", "Admin", "$2a$11$PeS4ElMWe8DCsd5Dhlmu5u", "admin" },
                    { 2, new DateTime(2025, 5, 27, 15, 25, 17, 737, DateTimeKind.Utc).AddTicks(8888), "Поддержка", "tech1@example.com", true, null, "Техник Иванов", "123456", "Технический специалист", "TechSupport", "$2a$11$CO2ODmpW8tN1JWMlwUF1te", "tech1" }
                });
